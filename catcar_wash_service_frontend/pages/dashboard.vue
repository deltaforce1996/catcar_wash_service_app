...
const hasFilterChanges = computed(() => {
  return (
    ...
    JSON.stringify([...tempSelectedUserIds.value].sort()) !==
      JSON.stringify([...selectedUserIds.value].sort()) ||
    JSON.stringify([...tempSelectedPaymentStatuses.value].sort()) !==
      JSON.stringify([...selectedPaymentStatuses.value].sort()) ||
    JSON.stringify([...tempSelectedDeviceTypes.value].sort()) !==
      JSON.stringify([...selectedDeviceTypes.value].sort())
  );
});
